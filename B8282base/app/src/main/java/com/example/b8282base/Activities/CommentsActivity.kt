package com.example.b8282base.Activities
...
import com.example.b8282base.*
import com.example.b8282base.Adapters.CommentsAdapter
            ...
            .addSnapshotListener { snapshot, exception ->
                ...
                if(snapshot != null){
                    ...
                    for(document in snapshot.documents){
                        ...
                        val newComment = Comment(name, timestamp.toDate(), commentText)
