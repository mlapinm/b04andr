...
import com.example.b8382base.Adapters.ThoughtsAdapter
import com.example.b8382base.Interfaces.ThoughtOptionsClickListener
import com.example.b8382base.Model.Thought
...
class MainActivity : AppCompatActivity(), ThoughtOptionsClickListener {
    ...
    override fun thoughtOptionMenuClicked(thought: Thought) {
        ...
        Log.d("exception", "present the alert dialog")
            ...
            deleteCollection(collectionRef, thought){ success ->
                thoughtRef.delete()
                    ...
                    .addOnFailureListener { exception ->
                        Log.d("exception", "Could not delete thought ${exception.localizedMessage}")
                    }
            }
         }
                ...
                thread {
                    ...
                    batch.commit()
                        ...
                        .addOnFailureListener { exception ->
                            Log.d(
                                "exception",
                                "Could not delete subcollection ${exception.localizedMessage}"
                            )
                        }
                }
            }
